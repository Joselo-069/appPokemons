...
const CreatePokemon = () => {
    ...
    const handleSelect = (e) => {
        const value = e.target.value ? e.target.value : 'normal';
        if (value) {
            setInput({
                ...input,
    ...
    const handleSubmit = (e) => {
        ...
        if (input.typeId.length) {
            for (let i = 0; i < input.typeId.length; i++) {
                formData.append('typeId', input.typeId[i]);            
            }
        }else{
            formData.append('typeId','normal');
        }
    ...
    //    console.log(res);
        ...
        // console.log(input.typeId.length);
            ...
            <nav className={style.menu}>
                ...
                <div className={style.menuLeft}>
                    <li className={style.menuLink}>
                        <h1 className={style.titleCreate}>Create Pokemon</h1>
                    </li>

                    <li className={style.menuLink}>
                        <h1 className={style.titleCreate}>N° 0{allPokemons.length +1 }</h1>
                    </li>
                </div>
                ...
                <form onSubmit={(e) => handleSubmit(e)} className={style.formCreate}>
                        ...
                        <div>
                            ...
                            <div className={style.contenedorBtn}>
                                <button type="submit" disabled={Object.keys(erros).length} className={style.btnCreate}>
                                    <img src="/imagenes/create.jpg" alt="" width={20} />
                                    Create
                                </button>
                            </div>
                        </div>
